...
contract GovernorContract is Governor, GovernorSettings, GovernorCountingSimple, GovernorVotes, GovernorTimelockControl {
    ...
    constructor(IVotes _token, TimelockController _timelock)
        ...
        GovernorSettings(1, /* 1 block voting delay */
                        45818, /* 1 week voting period (assuming 13.2s blocks) */
    ...
    function quorum(uint256 blockNumber) public view override(IGovernor, GovernorVotes) returns (uint256) {
